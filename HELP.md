...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
* [Spring Security](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/index.html#web.security)
* [OAuth2 Client](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/index.html#web.security.oauth2.client)
...
* [JDBC API](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/index.html#data.sql)
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/2.7.18/reference/htmlsingle/index.html#data.sql.jdbc)
